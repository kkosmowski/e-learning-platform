...
export default function CreateUser() {
  ...
  const onSubmit = async (userData: CreateUserForm) => {
    try {
      ...
      setErrorText('');
      toast.success(t('settings:users.createUser.userCreated'));
      formik.resetForm();
  ...
  return (
    <form onSubmit={handleSubmit}>
      <Stack spacing={2} sx={{ maxWidth: 600 }}>
        <TextField
          name="email"
          placeholder={t('settings:users.createUser.placeholder.email')}
          value={values.email}
        ...
        <TextField
          name="firstName"
          placeholder={t('settings:users.createUser.placeholder.firstName')}
        ...
        <TextField
          name="lastName"
          placeholder={t('settings:users.createUser.placeholder.lastName')}
